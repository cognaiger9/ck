...
// ######|        |        |        |          |          |          |            |                 |            |            |            |               |         |      |      |      |      |    |    |     |     |     |     |                |               |               |               |               |               |          |                |               |               |              |               |               |          |            |            |                             |                |           |            |             |             |
         < ALayout, BLayout, CLayout, ADataType, BDataType, CDataType, AccDataType, CShuffleDataType,  AElementOp,  BElementOp,  CElementOp,    GemmDefault,        1,   256,   MPB,   NPB,   KPB,  16,BK11,MPXDL,NPXDL,MXPW,  NXPW,     S<4, 64, 1>,     S<1, 0, 2>,     S<1, 0, 2>,              2,            ASP,            ADB,     BOOL1,     S<4, 64, 1>,     S<1, 0, 2>,     S<1, 0, 2>,           BS1,           BSP,             BDP,     BOOL2,        CMPS,           1,               S<1, 64, 1, 4>,               8,  LoopSched, PipelineVer, ComputeTypeA, ComputeTypeB>;
// clang-format on
