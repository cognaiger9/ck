                                                     ...
                                                     CElementwiseOperation>
{
    ...
    std::string GetTypeString() const override
    {
        ...
        str << "DeviceGemm_Xdl_CShuffleV2"
            ...
            << MXdlPerWave << ", "
            << NXdlPerWave << ", "
            << Printer<ABlockTransferThreadClusterLengths_AK0_M_AK1>::print() << ", "
            << Printer<ABlockTransferThreadClusterArrangeOrder>::print() << ", "
            << Printer<ABlockTransferSrcAccessOrder>::print() << ", "
            << ABlockTransferSrcVectorDim << ", "
            << ABlockTransferSrcScalarPerVector << ", "
            << ABlockTransferDstScalarPerVector_AK1 << ", "
            << ABlockLdsExtraM << ", "
            << Printer<BBlockTransferThreadClusterLengths_BK0_N_BK1>::print() << ", "
            << Printer<BBlockTransferThreadClusterArrangeOrder>::print() << ", "
            << Printer<BBlockTransferSrcAccessOrder>::print() << ", "
            << BBlockTransferSrcVectorDim << ", "
            << BBlockTransferSrcScalarPerVector << ", "
            << BBlockTransferDstScalarPerVector_BK1 << ", "
            << BBlockLdsExtraN << ", "
            << CShuffleMXdlPerWavePerShuffle << ", "
            << CShuffleNXdlPerWavePerShuffle << ", "
            << Printer<CShuffleBlockTransferClusterLengths_MBlock_MPerBlock_NBlock_NPerBlock>::print() << ", "
            << CShuffleBlockTransferScalarPerVector_NPerBlock
            << ">"
            << " LoopScheduler: "
